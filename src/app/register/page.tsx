        ...
        <>
            ...
            {state ? (
                ...
                <form action={action} className="flex flex-col">
                    ...
                    >
                        <option disabled></option> // Empty option can't be picked
                        <option>Mr</option> // Options user can choose
                        <option>Ms</option>
                        <option>Mrs</option>
                        <option>Dr</option>
                        <option>Prof</option>
                    ...
                    <label htmlFor="nameFirst" className="font-semibold">
                        First Name (ስም) <Asterisk /> // Label with required marker
                    </label>
                    <input
                    ...
                    <p>Nine digits. Do not begin with zero.</p> // Instruction text
                    <input
                        name="mobileNumber"
                        id="mobileNumber"
                        required
                    ...
                    >
                        ...
                        <option>Other</option> // Option to enter custom organization
                    </select>
